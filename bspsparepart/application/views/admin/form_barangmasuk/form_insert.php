            ...
            <?php } ?>
              ...
              <div class="box-body">
                ...
                <div class="form-group" style="margin-bottom:40px;">
                  <label for="nama_barang" style="margin-left:220px;display:inline;">Supplier</label>
                  <select class="form-control" name="lokasi" style="margin-left:63px;width:20%;display:inline;">
                    <option value="">-- Pilih --</option>
                    <option value="Hino">Hino</option>
                    <option value="Carfix">Carfix</option>
                    <option value="Pantura">Pantura</option>
                    <!-- <option value="H 1465 WH">H 1465 WH</option>
