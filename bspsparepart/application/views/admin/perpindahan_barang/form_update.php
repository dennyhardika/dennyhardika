...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url('admin')?>" class="logo">
      ...
      <span class="logo-lg"><b>Admin</b>Workshop</span>
    </a>
          ...
          <div class="box box-primary" style="width:94%;">
            ...
            <?php } ?>
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="lokasi" style="margin-left:220px;display:inline;">Supplier</label>
                  <input type="text" name="lokasi" style="margin-left:105px;width:20%;display:inline;" class="form-control" readonly="readonly" value="<?=$d->lokasi?>">
                </div>
                <!--  tambahan pilihan nopol -->
                <div class="form-group" style="margin-bottom:40px;">
                  <label for="nama_barang" style="margin-left:220px;display:inline;">Nopol</label>
                  <select class="form-control" name="Nopol" style="margin-left:119px;width:20%;display:inline;" class="form-control" required="" placeholder="Klik Disini">
                    <option value="">-- Pilih --</option>
                    <option value="H 9535 GA">H 9535 GA</option>
                    <option value="H 8101 KA">H 8101 KA</option>
                    <option value="H 8570 MA">H 8570 MA</option>
                    <option value="H 8569 MA">H 8569 MA</option>
                    <option value="H 9563 NA">H 9563 NA</option>
                    <option value="H 9565 NA">H 9565 NA</option>
                    <option value="H 9564 NA">H 9564 NA</option>
                    <option value="H 1361 HP">H 1361 HP</option>
                    <option value="H 8360 SA">H 8360 SA</option>
                    <option value="H 9869 OF">H 9869 OF</option>
                    <option value="H 9127 PA">H 9127 PA</option>
                  </select>
                </div>
                <!--  batas tambahan pilihan nopol -->
